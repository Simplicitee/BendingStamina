...
public abstract class StaminaCommand implements SubCommand {
	
	public static Map<String, StaminaCommand> instances = new HashMap<>();
	...
	public StaminaCommand(String name, String properUse, String description, String[] aliases) {
		this.name = name;
